...
public class StringService {
	 ...
	 *     s1 += "world"l       // 참조 주소 : 0x300 -> 참조주소가 달라짐
	 *     --> 새로운 객체 추가
	 *   
	 */
	...
	public void test1() {
		...
		// String System.identityHashCode(Object obj)
		// -> 객체를 구분하는 해시코드 반환
	...
	public void test2() {
		...
		System.out.println("[참조 주소 비교]s1 == s2 : " + (s1 == s3)); // false
