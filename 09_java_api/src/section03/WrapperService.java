...
//		System.out.println("값 출력 : " + obj); 
	...
	public void printValue2(Object obj) {
		...
		System.out.println("Auto Unboxing 후 값출력 : "+ num);
	...
	public void test3() {
		...
		System.out.println("[기본자료형 -> String으로 변환]");
		...
		// 방법 2) Wrapper Class의 valueOf() / toString() 사용
