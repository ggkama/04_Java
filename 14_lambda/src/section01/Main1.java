...
public class Main1 {
	public static void main(String[] args) {
		...
		System.out.println("calc3.sumTwoNumber(10,99) : " + calc3.sumTwoNumber(10, 99));
		
		
		// {} 내부 코드가 한줄이면 -> {}, return 생략가능
		Calculator calc4 = (a,b) ->	2*(a+b);
		System.out.println("calc4.sumTwoNumber(10,99) : " + calc4.sumTwoNumber(10, 99));
