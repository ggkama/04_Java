...
public class ScannerEx1 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * - java.util 패키지에 존재
		 *    -> 사용시 import java.util.Scanner 구문을 가져와야함
		 * 
		 */
		
		// Scanner 생성 구문
		Scanner sc = new Scanner(System.in);
		// 키보드 입력을 읽어올 객체 Scanner를 생성 -> new Scanner(System.in);
		// 생성 후 sc 변수에 저장
		
		// new 연산자 : Heap 메모리 영역에 새로운 객체 생성
		// new Scanner() : Heap 메모리 영역에 Scanner 객체를 생성
		// System.in : 지정된 입력장치(이클립스에서는 기본값 : 키보드) -> 키보드에 있는 값을 읽어 오겠다
	  ...
	  // sc.nextInt();
		...
		// * InputMismatchException -> 입력값의 자료형이 맞지 않음 예외
