...
public class VariableEx1 {
	...
	public static void main(String[] args) {
		...
		// sysout -> ctrl + space -> enter : println() snippet 자동완성
		System.out.println("----------------------------");
		...
		if(bool1 && !bool2) {
			System.out.println("bool1, !bool2 출력 가능?");
		}
		...
		// -> int 범위 초과한 값은 대입 불가
		// --> 정수형 중에서 범위가 더 큰 long을 사용한다
//		int intNum2 = 2147483648;
		
		// 2147483648 <- 일반 정수 표기법 == int로 인식
		// 2147483648L 또는 2147483648l로 표기 == long으로 인식
		long longNum1 = 2147483648L;
		
		// 자릿수 구분을 위해 _사용 가능 -> 연산시 인식 x 
		...
		// byte, short : 다른언어(c)와 호환을 위해 남겨진 자료형
		// -> 별도의 리터럴 표기법 x
		// -> 초기화시 int타입 표기법 사용
		byte byteNum = 100;
