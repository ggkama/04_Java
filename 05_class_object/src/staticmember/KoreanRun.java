...
public class KoreanRun {
	...
	public static void main(String[] args) {
		...
		Korean k2 = new Korean("이미영", "050304-9876543");
		
		// 국가 코드 세팅
//		k1.setNationalCode(82);
//		k2.setNationalCode(82);
		// Korean 객체가 생설될 때 마다 세팅하기 불편함
		// -> Korean 클래스에 nationalCode 필드에 값을 
		// 명시적으로 초기화
...
//		k2.setNationalCode(1);
		// -> 생성된 모든 Korean 객체에 하나씩 접근해서 값 수정해야함
		// --> static을 이용해서 문제 해결
		
		// static 변수 값 변경
		// -> 모든 Korean 객체의 nationalCode가 일관변
