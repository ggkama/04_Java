...
public class ArrayService1 {
	...
	public void method4() {
		...
		// arr이 참조하는 배열에 존재하는 inder : 0 1 2
		// -> 존재하지 않는 3번 인덱스에 값 대입
	...
	public void method5() {
		...
		// 0번은 비교할 필요가없으니 1번부터 비교시작 (int i = 1)
